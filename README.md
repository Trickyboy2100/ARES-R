...
新增固定起点与 `curobo demo cycle20`（规划复位 → 20 cm 规划 → servo dashboard）；新版完整循环实机验收待现场完成。正式模块边界、tmp 示教点/servo 成果迁移与静态避障输入见 [servo 接入说明](docs/SERVO_INTEGRATION_2026-09-07.md)。
